...
public class ContactModificationTest extends TestBase {
    ...
    public void testContactModification() {
        ...
        app.getContactHelper().fillContactForm(new ContactData("Modify", "New", "Vas", "chirp", "title", "PFT", "New Dark st, 4//13-7", "6765867867979", "23477894", "08653423", "4654769", null), false);
